...
<body>
    ...
    <script>
        // 1. Assim que a página carrega, verifica se o usuário já tinha escolhido o modo escuro antes
        if (localStorage.getItem('tema-escuro') === 'ativado') {
            document.body.classList.add('dark-mode');
        }

        // 2. Função que ativa/desativa o tema e salva a preferência na memória do navegador
        function alternarTema() {
            document.body.classList.toggle('dark-mode');
            
            // Se o modo escuro estiver ativo, salva "ativado", senão remove
